    ...
    <>
      <section className="space-y-4 mt-14 py-14 px-10 bg-white h-screen">
        ...
        <div className="flex space-x-4">
          ...
          <div className="text-customHover">{status}</div>
        </div>
        <div className="flex">
      ...
      <FooterButtonStart
        title={helpTextStartUp.title}
        description={helpTextStartUp.description}
